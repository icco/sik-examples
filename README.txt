...
1. If you haven't yet, install the Arduino IDE (http://www.arduino.cc)
2. Download the latest SIK Guide Code (http://sparkfun.com/sikcode)
3. Unzip the above file.
4. Place the "SIK Guide Code" folder in the Arduino IDE "examples" directory:
...
5. Start the Arduino IDE; the examples should be visible in File/Examples/SIK Guide Code

Sketch topics:

1.  Blinking an Light-Emitting Diode (LED) 
...
These sketches were written by SparkFun Electronics, with lots of help from the Arduino community. This code is completely free for any use.
